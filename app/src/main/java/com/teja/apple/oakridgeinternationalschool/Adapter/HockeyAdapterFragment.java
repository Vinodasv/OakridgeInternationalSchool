 ...
 */
public class HockeyAdapterFragment  extends RecyclerView.Adapter< HockeyAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  HockeyAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  HockeyAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_hockey_adapter, parent, false);
        return new  HockeyAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( HockeyAdapterFragment.myviewholder holder, int position) {
