 ...
 */
public class CarromBoardAdapterFragment  extends RecyclerView.Adapter< CarromBoardAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  CarromBoardAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  CarromBoardAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_carrom_board_adapter, parent, false);
        return new  CarromBoardAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( CarromBoardAdapterFragment.myviewholder holder, int position) {
