...
public class CricketAdapter extends RecyclerView.Adapter< CricketAdapter.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  CricketAdapter(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  CricketAdapter.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cricket_adapter, parent, false);
        return new  CricketAdapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( CricketAdapter.myviewholder holder, int position) {
