 ...
 */
public class TennisAdapterFragment extends RecyclerView.Adapter< TennisAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  TennisAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  TennisAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_tennis_adapter, parent, false);
        return new  TennisAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( TennisAdapterFragment.myviewholder holder, int position) {
