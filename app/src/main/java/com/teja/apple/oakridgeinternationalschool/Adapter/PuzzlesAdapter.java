...
public class PuzzlesAdapter extends RecyclerView.Adapter<PuzzlesAdapter.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public PuzzlesAdapter(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public PuzzlesAdapter.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_puzzles_riddles_fragment2, parent, false);
        return new PuzzlesAdapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(PuzzlesAdapter.myviewholder holder, int position) {
