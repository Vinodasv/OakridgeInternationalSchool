...
public class BasketBallAdapter  extends RecyclerView.Adapter< BasketBallAdapter.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  BasketBallAdapter(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    public  BasketBallAdapter.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_basket_ball_adapter, parent, false);
        return new  BasketBallAdapter.myviewholder(view);
    }
