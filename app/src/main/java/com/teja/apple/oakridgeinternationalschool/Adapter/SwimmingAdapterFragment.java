 ...
 */
public class SwimmingAdapterFragment  extends RecyclerView.Adapter< SwimmingAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  SwimmingAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  SwimmingAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_swimming_adapter, parent, false);
        return new  SwimmingAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( SwimmingAdapterFragment.myviewholder holder, int position) {
