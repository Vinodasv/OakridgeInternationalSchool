 ...
 */
public class VolleyBallAdapterFragment  extends RecyclerView.Adapter< VolleyBallAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  VolleyBallAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  VolleyBallAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_volley_ball_adapter, parent, false);
        return new  VolleyBallAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( VolleyBallAdapterFragment.myviewholder holder, int position) {
