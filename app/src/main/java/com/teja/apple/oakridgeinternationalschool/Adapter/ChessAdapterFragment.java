 ...
 */
public class ChessAdapterFragment  extends RecyclerView.Adapter< ChessAdapterFragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  ChessAdapterFragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  ChessAdapterFragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_chess_adapter, parent, false);
        return new  ChessAdapterFragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( ChessAdapterFragment.myviewholder holder, int position) {
