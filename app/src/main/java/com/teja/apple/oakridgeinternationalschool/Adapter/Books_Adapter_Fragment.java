 ...
 */
public class Books_Adapter_Fragment extends RecyclerView.Adapter<Books_Adapter_Fragment.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public Books_Adapter_Fragment(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public Books_Adapter_Fragment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_books__adapter_, parent, false);
        return new Books_Adapter_Fragment.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(Books_Adapter_Fragment.myviewholder holder, int position) {
