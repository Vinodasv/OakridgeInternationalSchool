...
public class BadmintonAdapter  extends RecyclerView.Adapter< BadmintonAdapter.myviewholder>implements View.OnClickListener {
    String sports;
    ...
    public  BadmintonAdapter(ArrayList<Model> Model, Activity activity) {
        List = Model;
//            anInterface = fragmentInterface;
    ...
    @Override
    public  BadmintonAdapter.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_badminton_adapter, parent, false);
        return new  BadmintonAdapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder( BadmintonAdapter.myviewholder holder, int position) {
